        ...
        <div class="col-md-5 offset-md-4">
            <div class="card-body">
                <div class="text-center">
                    ...
                    <div class="card-title mt-3"> Registeration </div>    
                </div>
                ...
                <div class="form-group">
                    <input type="password" class="form-control" id="exampleInputPassword2" placeholder="Confirm Password" name="passwd" required>
                </div>
                <div class="text-center">
